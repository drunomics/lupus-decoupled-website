...
These types are auto-imported by Nuxt. See the [Canvas prop types documentation](https://project.pages.drupalcode.org/canvas/sdc-components/props/#prop-types-and-examples) in the Canvas docs for details.
