...
[nuxt-component-preview](https://github.com/drunomics/nuxt-component-preview) is a Nuxt module that enables previewing Vue components in external contexts like iframes. It ships as part of [nuxtjs-drupal-ce](https://github.com/drunomics/nuxtjs-drupal-ce) and is the foundation for [Drupal Canvas](/guide/canvas) integration.
...
When using [nuxtjs-drupal-ce](https://github.com/drunomics/nuxtjs-drupal-ce), CORS is configured automatically based on `drupalCe.drupalBaseUrl`. For other setups, configure CORS manually via Vite (dev) and Nitro route rules (production).
...
Define metadata for a component via a JSDoc comment at the top of `<script setup>`:
...
| Tag | Description |
|---|---|
| First line | Custom display name (falls back to auto-generated from PascalCase) |
...
Props are defined using TypeScript with JSDoc annotations:
...
Prop titles are auto-generated from the first JSDoc line or prop name. Use `@title` to override.
