...
@todo Mention Lupus CSR themes and that option here as well, we need to structure this page new to add this option. this page is written for Deployment strategies with a separate frontend, we also have the Lupus Theme deployment option now.