...
A third option is to bundle the frontend SPA directly as a Drupal theme using [Lupus CSR](https://www.drupal.org/project/lupus_csr). In this case:

- No separate frontend server is needed; any standard Drupal hosting works
