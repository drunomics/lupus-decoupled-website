...
With [Lupus CSR](https://www.drupal.org/project/lupus_csr), the pre-built frontend application is bundled directly as a Drupal theme. No separate frontend server is needed:
