...
::note
If you are using [theme-based deployment](/deployment/deployment-strategy#theme-based-deployment-csr), any standard Drupal hosting works without Node.js support. The options below are for setups with a separate frontend server.
::
...
See the [Deploy on Pantheon](/deployment/pantheon) guide for step-by-step instructions.
