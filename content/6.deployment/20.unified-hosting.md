...
::alert{type="info"}
If you are using [Lupus CSR](https://www.drupal.org/project/lupus_csr) (theme-based deployment), any standard Drupal hosting works without Node.js support. The options below are for setups with a separate frontend server.
::
