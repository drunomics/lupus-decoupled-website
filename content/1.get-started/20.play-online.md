...
- [Nuxt Naked Starter](https://codespaces.new/drunomics/lupus-decoupled-project?quickstart=1){target="_blank"}
- [Nuxt with shadcn/ui components](https://codespaces.new/drunomics/lupus-decoupled-project?quickstart=1&devcontainer_path=.devcontainer%2Fnuxt-shadcn%2Fdevcontainer.json){target="_blank"}
- [Next.js frontend](https://codespaces.new/drunomics/lupus-decoupled-project?quickstart=1&devcontainer_path=.devcontainer%2Fnextjs%2Fdevcontainer.json){target="_blank"}
- [Drupal CMS Blog Recipe (WIP)](https://codespaces.new/drunomics/lupus-decoupled-project?quickstart=1&devcontainer_path=.devcontainer%2Frecipe-blog%2Fdevcontainer.json){target="_blank"}
- [Drupal CMS Starter Recipe (WIP)](https://codespaces.new/drunomics/lupus-decoupled-project?quickstart=1&devcontainer_path=.devcontainer%2Frecipe-demo%2Fdevcontainer.json){target="_blank"}
