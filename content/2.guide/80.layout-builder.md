...
::note
**Consider using [Drupal Canvas](/guide/canvas) instead.** Canvas is Drupal's modern page builder and supersedes Layout Builder for most decoupled use cases. Layout Builder remains supported but Canvas is recommended for new projects.
::
